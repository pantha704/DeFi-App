...
/***/ "./src/declarations/dbank_frontend/dbank_frontend.did.js":
/*!***************************************************************!*\
  !*** ./src/declarations/dbank_frontend/dbank_frontend.did.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/dbank_frontend/index.js":
/*!**************************************************!*\
  !*** ./src/declarations/dbank_frontend/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   canisterId: () => (/* binding */ canisterId),
/* harmony export */   createActor: () => (/* binding */ createActor),
/* harmony export */   dbank_frontend: () => (/* binding */ dbank_frontend),
/* harmony export */   idlFactory: () => (/* reexport safe */ _dbank_frontend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var _dbank_frontend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dbank_frontend.did.js */ "./src/declarations/dbank_frontend/dbank_frontend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  // Creates an actor with using the candid interface and the HttpAgent
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_dbank_frontend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
    ...options.actorOptions,
  });
...
const dbank_frontend = createActor(canisterId);
...
/* harmony import */ var _declarations_dbank_frontend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../declarations/dbank_frontend */ "./src/declarations/dbank_frontend/index.js");


   
window.addEventListener("load", async() =>  {
  console.log("Finished loading");
  var currentAmount = Math.round(await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.checkBalance() * 100) / 100;
...
document.querySelector("form").addEventListener("submit", async (event) => {
  ...
  inputAmount ? await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.topUp(inputAmount) : null;

  outputAmount ? await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.withdraw(outputAmount) : null;
